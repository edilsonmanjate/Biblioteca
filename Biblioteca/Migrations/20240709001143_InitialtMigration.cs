        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ano = table.Column<string>(type: "nvarchar(13)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Livros",
                columns: new[] { "Id", "Ano", "Autor", "ISBN", "Titulo" },
                values: new object[,]
                {
                    { 1, "1954", "J.R.R. Tolkien", "9780345339706", "O Senhor dos Anéis" },
                    { 2, "2003", "Dan Brown", "9780552149518", "O Código Da Vinci" },
                    { 3, "1943", "Antoine de Saint-Exupéry", "9788572329864", "O Pequeno Príncipe" },
                    { 4, "1605", "Miguel de Cervantes", "9789726081533", "Dom Quixote" },
                    { 5, "1937", "J.R.R. Tolkien", "9780345339683", "O Hobbit" },
                    { 6, "1997", "J.K. Rowling", "9780747532743", "Harry Potter e a Pedra Filosofal" },
                    { 7, "1988", "Paulo Coelho", "9780062315007", "O Alquimista" },
                    { 8, "1947", "Anne Frank", "9788587220851", "O Diário de Anne Frank" }
                });
